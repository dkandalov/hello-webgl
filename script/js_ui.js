...
dat.utils.common = function() {
	...
	return{BREAK: {}, extend: function(c) {
...
var c = {};
e.each({HTMLEvents: ["change"], MouseEvents: ["click", "mousemove", "mousedown", "mouseup", "mouseover"], KeyboardEvents: ["keydown"]}, function(b, a) {
	e.each(b, function(b) {
		c[b] = a
	})
});
var d = /(\d+(\.\d+)?)px/, f = {makeSelectable: function(b, a) {
...
a.bind(this.__select, "change", function() {
        ...
        d.superclass = e;
        c.extend(d.prototype, e.prototype, {setValue: function(a) {
...
c.superclass = e;
a.extend(c.prototype, e.prototype, {setValue: function(a) {
...
this.__input = document.createElement("input");
        ...
        d.superclass = e;
        c.extend(d.prototype, e.prototype, {updateDisplay: function() {
    ...
    dat.controllers.NumberControllerSlider = function(e, a, c, d, f) {
        ...
        d.extend(b.prototype, e.prototype, {updateDisplay: function() {
...
return b
    ...
    dat.controllers.FunctionController = function(e, a, c) {
        ...
        d.superclass = e;
        c.extend(d.prototype, e.prototype, {fire: function() {
...
dat.color.interpret = function(e, a) {
	...
	return a === null ? false : {space: "HEX", hex: parseInt("0x" + a[1].toString() + a[1].toString() + a[2].toString() + a[2].toString() + a[3].toString() + a[3].toString())}
...
return a === null ? false : {space: "HEX", hex: parseInt("0x" + a[1].toString())}
	...
	return a === null ? false : {space: "RGB", r: parseFloat(a[1]), g: parseFloat(a[2]), b: parseFloat(a[3]), a: parseFloat(a[4])}
}, write: e}}},
	...
	return[a.r, a.g, a.b, a.a]
            ...
            {litmus: a.isObject, conversions: {RGBA_OBJ: {read: function(b) {
...
this.domElement = document.createElement("div");
            ...
            Object.defineProperties(this, {parent: {get: function() {
                ...
                for (b = 0; b < this.__preset_select.length; b++)if (this.__preset_select[b].value == this.preset)this.__preset_select.selectedIndex = b;
                d.revert()
            }}, width: {get: function() {
                return a.width
            }, set: function(b) {
        ...
        i.extend(k.prototype, {add: function(a, b) {
...
h.superclass = e;
f.extend(h.prototype, e.prototype, {updateDisplay: function() {
...
f.extend(this.__field_knob.style, {marginLeft: 100 * this.__color.s - 7 + "px", marginTop: 100 * (1 - this.__color.v) - 7 + "px", backgroundColor: this.__temp.toString(), border: this.__field_knob_border +
	"rgb(" + h + "," + h + "," + h + ")"});
...
d.extend(j.prototype, {toString: function() {
	return c(this)
	}, toOriginal: function() {
...
Object.defineProperty(j.prototype, "hex", {get: function() {
...
return j
	...
	var e;
	return{hsv_to_rgb: function(a, c, d) {
	var e = a / 60 - Math.floor(a / 60), b = d * (1 - c), n = d * (1 - e * c), c = d * (1 - (1 - e) * c), a = [
	[d, c, b],
	[n, d, b],
	[b, d, c],
	[b, n, d],
